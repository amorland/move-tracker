...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  owner TEXT NOT NULL CHECK (owner IN ('Andrew', 'Wife', 'Both')),
  dueDate TEXT,
...
-- Rename columns for locations casing
-- ALTER TABLE locations RENAME COLUMN createdat TO "createdAt"; -- Handled by running renaming script
